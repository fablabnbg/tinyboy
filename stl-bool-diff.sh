...
#
# uses blender as a python interpreter
# /usr/bin/blender --background --python /tmp/tmpr02niw


import os
import sys
blender_py_dir = '/usr/share/blender/scripts/modules/'
sys.path.append(blender_py_dir)
import bpy
...
if __name__ == "__main__":
  ...
  if args.intersection is not None: stl_bool_method='INTERSECTION'
  if args.union        is not None: stl_bool_method='UNION'
